...
E2ETest_Test_Type() {
  ...
  #When
  actual=$($(Files_Path_Pipeliner)/test --type unit --include core/test.test.sh)
  exitCode=$?
  ...
  #When
  actual=$($(Files_Path_Pipeliner)/test --type integration --include core/test.test.sh)
  exitCode=$?
  ...
  #When
  actual=$($(Files_Path_Pipeliner)/test --type e2e --include core/test.test.sh)
  exitCode=$?
...
#   E2ETest_Test_Watch_thread &
#   actual=$($(Files_Path_Pipeliner)/test --watch)
#   exitCode=$?
...
E2ETest_Test_Arguments() {
  ...
  #When
  actual=$($(Files_Path_Pipeliner)/test --help)
  exitCode=$?
  ...
  #When
  actual=$($(Files_Path_Pipeliner)/test --version)
  exitCode=$?
...
E2ETest_Test_Arguments_Fail() {
  ...
  #When
  actual=$($(Files_Path_Pipeliner)/test --unknown 2>&1)
  exitCode=$?
